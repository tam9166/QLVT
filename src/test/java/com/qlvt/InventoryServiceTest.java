...
class InventoryServiceTest {
    ...
    @Test
    void issueFefoCreatesMovementForEachBatchAllocation() {
        ...
        when(batchRepository.findIssuableBatchesFefo(1L, LocalDate.now())).thenReturn(List.of(batchA, batchB));
        ...
        assertThat(movements).extracting(StockMovement::getBeforeQuantity).containsExactly(50, 30);
        assertThat(movements).extracting(StockMovement::getAfterQuantity).containsExactly(30, 15);
